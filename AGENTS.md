...
| `test_devin_default_model.bats` | 9 | Devin default model swe-1.6 (loop default, env-snapshot non-clobber, precedence --model > DEVIN_MODEL env > .ralphrc.devin > default, build_devin_command passthrough, workspace_plan_run_engine + plan-path default) |
