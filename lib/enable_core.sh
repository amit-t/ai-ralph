...
generate_ralphrc() {
    ...
    case "$project_type" in
        javascript|typescript)
            lang_tools=",Bash(npm *),Bash(pnpm *),Bash(yarn *),Bash(bun *),Bash(npx *),Bash(node *)"
            ;;
        python)
            lang_tools=",Bash(python *),Bash(pip *),Bash(uv *),Bash(pytest *)"
            ;;
        rust)
            lang_tools=",Bash(cargo *),Bash(rustc *)"
            ;;
        go)
            lang_tools=",Bash(go *)"
            ;;
        *)
            lang_tools=",Bash(npm *),Bash(pnpm *),Bash(yarn *),Bash(bun *)"
            ;;
    esac

    local allowed_tools="${base_tools}${lang_tools}"
